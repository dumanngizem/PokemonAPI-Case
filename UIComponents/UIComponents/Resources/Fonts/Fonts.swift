...
public enum FontFamily {
  public enum Athiti {
    public static let regular = FontConvertible(name: "Athiti-Regular", family: "Athiti", path: "Athiti-Regular.ttf")
    public static let all: [FontConvertible] = [regular]
  }
  public enum Dongle {
    public static let bold = FontConvertible(name: "Dongle-Bold", family: "Dongle", path: "Dongle-Bold.ttf")
    public static let light = FontConvertible(name: "Dongle-Light", family: "Dongle", path: "Dongle-Light.ttf")
    public static let regular = FontConvertible(name: "Dongle-Regular", family: "Dongle", path: "Dongle-Regular.ttf")
    public static let all: [FontConvertible] = [bold, light, regular]
  }
  public enum Inter {
  ...
  public enum SecularOne {
    public static let regular = FontConvertible(name: "SecularOne-Regular", family: "Secular One", path: "SecularOne-Regular.ttf")
    public static let all: [FontConvertible] = [regular]
  }
  public static let allCustomFonts: [FontConvertible] = [Athiti.all, Dongle.all, Inter.all, SecularOne.all].flatMap { $0 }
